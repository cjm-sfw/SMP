...
# optimizer
optimizer = dict(type='SGD', lr=(0.001875*2), momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/MHP_release_r50_fpn_8gpu_1x_repparsing_v0_DCN/'
load_from = None
resume_from = None
workflow = [('train', 1)]
