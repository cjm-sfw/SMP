...
log_level = 'INFO'
work_dir = './work_dirs/densepose_release_r101_fpn_8gpu_3x_offset_parsing_v1/large_noneg/'
load_from = None
resume_from = './work_dirs/densepose_release_r101_fpn_8gpu_3x_offset_parsing_v1/large/epoch_30.pth'
workflow = [('train', 1)]
